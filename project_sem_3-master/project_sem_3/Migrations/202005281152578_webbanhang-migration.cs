namespace project_sem_3.Migrations
{
    ...
    public partial class webbanhangmigration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ExprirationDate = c.DateTime(nullable: false),
                        MinTotal = c.Double(nullable: false),
                        UseTime = c.Double(nullable: false),
                        Status = c.Int(nullable: false),
                        CreatedAt = c.DateTime(nullable: false),
                        UpdatedAt = c.DateTime(),
                        DeletedAt = c.DateTime(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrderDetails", "ProductDetailId", "dbo.ProductDetails");
            ...
            DropIndex("dbo.OrderDetails", new[] { "ProductDetailId" });
